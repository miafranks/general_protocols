...
11. Nitrite Working Stock (0.10M)
   1. Weigh ~0.345g of NaNO2 into a 50 mL Falcon tube
   2. Add up to 50mL water, mix well
...
12. Nitrate Working Stock (0.1M)
   1. Weigh 0.42495g of NaNO3 into a 50mL Falcon tube
   2. Add up to 50mL water, mix well
   3. Calculate exact concentration
      1. _______g/(84.99g/mol*50mL)*1,000,000 = __________mM
   4. Make Secondary (working) stock (1mM) from primary stock concentration
      1. (Primary stock concentration)___________mM x ______ml = 1mM x 50 mL
      2. Ex. ____________ uL = (1mM*50ml/(primary stock concentration)__________mM)*1000
      3. If primary stock concentration is 0.1M, then 500ul 
      4. Combine ___________ uL of primary working stock with up to 50ml MQ water
   5. Filter through a 0.2um filter to sterilize and store in fridge

### Standards Preparation 
1. Make nitrite standards
...
1. Make nitrate standards
   1. Label 9x 50mL Falcon Tubes as follows:
      ...
      10. 0uM
2. Rinse all tubes 3x with MQ water
3. Make 30uM nitrate standard
   1. In the 30uM tube, add 1.5ml of 1mM NO3 working stock into 48.5mL MQ water
   2. Vortex
4. Serial Dilutions to make standards
   1. Add 25ml MQ water to each empty tube
   2. Add 25ml of the 30uM standard into the 15uM standard tube
   3. Vortex
   4. Continue dilutions by taking 25ml from the previous concentration
   5. If continuing use, filter through a 0.2um filter to sterilize and store in fridge
...
1. Calculate total volume of SULF/NEDD mixture needed to run triplicate wells for each standard and sample:
   1. (# standards + # samples + 1 extra) x 3 x 80uL = total vol ______________ (uL).
   2. If quantifying both total NOx and NO2-, double the # samples.
   3. Account for both sample (no added SULF/NEDD mixture) and reagent blanks (nanopure plus reagents, i.e., 0. uM NOx).
3. Prepare the total volume of SULF/NEDD mixture needed by mixing equal parts of the reagents
   1. Ex. if need 3 mL total volume, add 1.5mL SULF to 1.5mL NEDD in 15mL tube
   2. Vortex to mix.
5. Aliquot 80uL of each sample/standard to the appropriate wells of a clear 96-well plate
6. Add 80 uL of VCl3 to each well for total NOx concentrations
7. Add 80 uL of nanopure water to each well for nitrite concentrations
8. Mix briefly by pipetting (use multichannel pipet)
   1. Be wary of bubbles 
10. Quickly add 80 uL of SULF/NEDD mixture to each well. Mix briefly by pipetting
...
2. Subtract the average absorbance of the nanopure water tubes (i.e., 0 uM NOx) mixed with diluting solution/medium instead of the SULF/NEDD mixture (standard blanks) from the absorbances of all the standards.
